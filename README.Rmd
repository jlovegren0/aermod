...
2. Second, a simulation plan is generated, consisting of randomly selected hours of operation for each simulation trial3. Third, Monte Carlo trials are run, each trial consisting of two steps:
...
4.  Results are evaluated following specified criteria.
